    ...
    <section className="section learning" id="formacao">
      <div className="shell">
        <div className="learning__top motion-reveal">
          <div>
            <p className="eyebrow">
              <span>04 /</span> formação em andamento
            </p>
            <h2>Aprendizado que já vira interface.</h2>
          </div>
          <div
            className="progress-orbit"
            style={{ '--progress': learning.progress }}
            aria-label={`${learning.progress}% do curso concluído`}
          >
            <div>
        ...
        <div className="learning__grid">
          <article className="competence-card motion-reveal">
            <small>
              MÓDULO {String(learning.currentModule).padStart(2, '0')} · COMPETÊNCIA ATUAL
            </small>
            <h3>{learning.title}</h3>
            <p>{learning.competence}</p>
            <div className="competence-status">
              <i />
        ...
        <details className="competency-map" aria-labelledby="competency-map-title">
          <summary className="learning-expand">
            Explorar os {learning.competencies.length} módulos da minha formação <span>+</span>
          </summary>
